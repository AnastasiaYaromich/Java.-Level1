...
import static TicTacToe.Maps.MODE_H_V_H;
...
public class StartNewGameWindow extends JFrame {
    ...
    public StartNewGameWindow(GameWindow gameWindow) {
        ...
        JButton btnSrartGame = new JButton("Start a Game");

        btnSrartGame.addActionListener(new ActionListener() {
            @Override
    ...
    void btnSrartGameClick() {
        int gameMode;
        if(jrbHumVsAi.isSelected()) {
            gameMode = Maps.MODE_H_V_A;
        } else {
            gameMode = Maps.MODE_H_V_H;
        }
